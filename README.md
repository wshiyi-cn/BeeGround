...
Click "Tools"-"BeeGround Settings" to change the parameters. There are three tabs in the settings: Arena settings, Robots settings and simulation settings.  
...
## Run the simulation
Then we click "Play" to run the simulation.
